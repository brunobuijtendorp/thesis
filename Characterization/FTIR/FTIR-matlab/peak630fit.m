function [cf_,gof,output]=peak630fit(waventofit,intensitiestofit,n0,nc,n,d,ini,ll,ul)
...
ft_ = fittype('0.5*(1+(c1+c2*x*1e-04)^2)*((4*(n^2+(((i1*0.4/s1)*exp(-0.5*((x-f1)/s1)^2)))^2)/((n+n0)^2+(((i1*0.4/s1)*exp(-0.5*((x-f1)/s1)^2)))^2))*(4*nc^2/((n+nc)^2+(((i1*0.4/s1)*exp(-0.5*((x-f1)/s1)^2)))^2))/(4*nc^2/((nc+n0)^2)))/(exp(-2*(-2*pi*(((i1*0.4/s1)*exp(-0.5*((x-f1)/s1)^2)))*d*1e-07)*x)+(c1+c2*x*1e-04)^2*(((n0-n)^2+(((i1*0.4/s1)*exp(-0.5*((x-f1)/s1)^2)))^2)/((nc+n)^2+(((i1*0.4/s1)*exp(-0.5*((x-f1)/s1)^2)))^2))*(((nc-n)^2+(((i1*0.4/s1)*exp(-0.5*((x-f1)/s1)^2)))^2)/((nc+n)^2+(((i1*0.4/s1)*exp(-0.5*((x-f1)/s1)^2)))^2))*exp(2*(-2*pi*(((i1*0.4/s1)*exp(-0.5*((x-f1)/s1)^2)))*d*1e-07)*x)-2*(c1+c2*x*1e-04)*(((n0^2-n^2-(((i1*0.4/s1)*exp(-0.5*((x-f1)/s1)^2)))^2)/((n0+n)^2+(((i1*0.4/s1)*exp(-0.5*((x-f1)/s1)^2)))^2))*((nc^2-n^2-(((i1*0.4/s1)*exp(-0.5*((x-f1)/s1)^2)))^2)/((nc+n)^2+(((i1*0.4/s1)*exp(-0.5*((x-f1)/s1)^2)))^2))-(2*n0*(((i1*0.4/s1)*exp(-0.5*((x-f1)/s1)^2)))/((n0+n)^2+(((i1*0.4/s1)*exp(-0.5*((x-f1)/s1)^2)))^2))*(2*nc*(((i1*0.4/s1)*exp(-0.5*((x-f1)/s1)^2)))/((nc+n)^2+(((i1*0.4/s1)*exp(-0.5*((x-f1)/s1)^2)))^2)))*cos(2*(2*pi*n*d*1e-07)*x)-2*(c1+c2*x*1e-04)*(((n0^2-n^2-(((i1*0.4/s1)*exp(-0.5*((x-f1)/s1)^2)))^2)/((n0+n)^2+(((i1*0.4/s1)*exp(-0.5*((x-f1)/s1)^2)))^2))*(2*nc*(((i1*0.4/s1)*exp(-0.5*((x-f1)/s1)^2)))/((nc+n)^2+(((i1*0.4/s1)*exp(-0.5*((x-f1)/s1)^2)))^2))+((nc^2-n^2-(((i1*0.4/s1)*exp(-0.5*((x-f1)/s1)^2)))^2)/((nc+n)^2+(((i1*0.4/s1)*exp(-0.5*((x-f1)/s1)^2)))^2))*(2*n0*(((i1*0.4/s1)*exp(-0.5*((x-f1)/s1)^2)))/((n0+n)^2+(((i1*0.4/s1)*exp(-0.5*((x-f1)/s1)^2)))^2)))*sin(2*(2*pi*n*d*1e-07)*x))',...%refers to m-file
    'dependent',{'y'},'independent',{'x'},...
    'coefficients',{'c1', 'c2', 's1', 'f1', 'i1'},'problem',{'n0','nc','n','d'});
...
print('-dpng', [dirtosave '\630fit.png'])
