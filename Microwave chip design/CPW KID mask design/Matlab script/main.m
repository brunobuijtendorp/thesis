...
% Set desired Q
Q = 1E3 * [50 50 100 100 150 ; 50 50 50 50 50 ; 10 10 10 10 10 ];  % one number for same Lc for all KIDs or array = 
...
for i = 1:3
    ...
    MaskGeneral_V1(design_Q, Qdesign, Q_i, strcat(script_dir, 'output'), output_filename_i, size_multiplier_i);
end